...
FLAGS = flags.FLAGS
flags.DEFINE_string('freebase_dir', '/tmp/data/freebase', 'Directory that containns Freebase'
                    ' graphs.')
flags.DEFINE_string('output_dir', '/wikigraphs/output', 'Path to output directory to store the'
                    ' paired dataset.')
